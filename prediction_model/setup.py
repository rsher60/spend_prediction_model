...
DESCRIPTION = 'A Logistic regression model that predicts spend ranges of customers for segmentation'
URL = 'https://github.com/rsher60'
AUTHOR = 'Riddhiman Sherlekar'
